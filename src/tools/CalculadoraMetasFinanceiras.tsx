          ...
          <aside className="vt-aside">
            ...
            <div className="vt-promo">
              ...
              <div className="vt-promo-overlay">
                ...
                <a href="#/investimentos/fundos" className="vt-promo-link">
                  Saiba mais
            ...
            <div className="vt-card vt-resources">
              ...
              <ul>
                {[
                  { icon: "article", title: "As Melhores Formas de Economizar", desc: "Pequenas mudanças, grandes resultados.", link: "#/despesas" },
                  { icon: "stats", title: "Comparador de Renda Fixa", desc: "Calcule qual melhor produto.", link: "#/ntas/renda-fixa" },
                  { icon: "bank", title: "Fundos, o que são", desc: "Qual o melhor para sua meta?", link: "#/investimentos/fundos" },
                  { icon: "calc", title: "Calculadora de Aposentadoria", desc: "O poder do tempo ao seu favor.", link: "#/ferramentas/aposentadoria" },
                ].map((item, i, arr) => (
                  <li key={i}>
                    <a href={item.link} className="vt-resource-link">
