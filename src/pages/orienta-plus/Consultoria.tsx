...
const services: ServiceCard[] = [
  {
    ...
    features: [
      ...
      "Verificação de compatibilidade da sua carteira com você",
  ...
  },
  {
    ...
    features: [
      ...
      "Proteção financeira",
      "Avaliação da eficiência da estrutura financeira",
      "Estratégias para organização e transferência de patrimônio.",
