...
import { fiiContent } from "@/content/fii";
...
const categories = [
  {
    ...
    icon: ShieldAlert,
    subcategories: [
      { id: "o-que-sao-fii", label: "Mas o que raios são fundos imobiliários?" },
    ],
  },
  {
    id: "guias",
    ...
    icon: BookOpen,
    subcategories: [
      { id: "cursos-fii", label: "Guia para iniciantes" },
    ],
  },
...
const Fundos = () => {
  ...
  const contentItems = useMemo<ContentItem[]>(
    () => fiiContent.map(parseMarkdownContent),
    []
  );
      ...
      <section className="py-8 md:py-12">
        <div className="container max-w-7xl">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-bold">Fundos de Investimento Imobiliários</h1>
          </div>
