import{r as g,j as e,S as R,O as E}from"./index-CzXAOLPy.js";const I="/favicon.png",P=.05,y=Math.pow(1+P,1/12)-1;function S(s){return"R$ "+Math.round(s).toLocaleString("pt-BR")}function M(s){return"R$ "+s.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}function B(s,v,n){let i=s;for(let c=1;c<=n;c++)i=i*(1+y)+v;return i}function T(s,v,n){const i=Math.pow(1+y,v);return i===1?(n-s*i)/v:(n-s*i)*y/(i-1)}function W(s,v,n,i,c,w){const p=Math.max(1,v-s),a=p*12;let f,o;if(w==="aporte")o=i,f=B(n,o,a);else{const l=c/y;f=l,o=Math.max(0,T(n,a,l))}const d=Math.max(0,n+o*a),u=Math.max(0,f-d),A=f*y,N=200;let b=0,x=n;for(let l=1;l<=a;l++)x=x*(1+y)+o+N,x>=f&&b===0&&(b=a-l);return{anos:p,meses:a,saldo:f,aporteEfetivo:o,totalInvestido:d,jurosGanhos:u,rendaPassiva:A,anosAntec:(b/12).toFixed(1),mid1Age:Math.round(s+p/3),mid2Age:Math.round(s+2*p/3),extra:N}}function L(s,v,n,i,c){const w=s.parentElement.getBoundingClientRect(),p=window.devicePixelRatio||1;s.width=w.width*p,s.height=200*p,s.style.width=w.width+"px",s.style.height="200px";const a=s.getContext("2d");a.scale(p,p);const f=w.width,o=200;a.clearRect(0,0,f,o);const d=80,u=[];for(let t=0;t<=d;t++){const m=Math.round(t*i/d);let k=v;for(let z=1;z<=m;z++)k=k*(1+y)+n;u.push(k)}const A=Math.max(...u,1),N=8,b=16,x=t=>N+t/d*(f-N*2),l=t=>o-b-t/A*(o-b*2),C=c==="aporte"?"#1daf66":"#FFA726",F=c==="aporte"?"rgba(29,175,102,0.18)":"rgba(255,167,38,0.15)",r=c==="aporte"?"rgba(29,175,102,0.01)":"rgba(255,167,38,0.01)",h=c==="aporte"?"#a8e6c8":"#FFD08A",j=a.createLinearGradient(0,0,0,o);j.addColorStop(0,F),j.addColorStop(1,r),a.beginPath(),a.moveTo(x(0),l(u[0]));for(let t=1;t<=d;t++)a.lineTo(x(t),l(u[t]));a.lineTo(x(d),o-b),a.lineTo(x(0),o-b),a.closePath(),a.fillStyle=j,a.fill(),a.beginPath(),a.moveTo(x(0),l(u[0]));for(let t=1;t<=d;t++)a.lineTo(x(t),l(u[t]));a.strokeStyle=C,a.lineWidth=2.5,a.lineJoin="round",a.stroke(),[0,Math.round(d/3),Math.round(2*d/3),d].forEach((t,m,k)=>{a.beginPath(),a.arc(x(t),l(u[t]),5,0,Math.PI*2),a.fillStyle=m===k.length-1?h:"#fff",a.strokeStyle=m===k.length-1?h:C,a.lineWidth=2.5,a.fill(),a.stroke()})}const O=()=>e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("polyline",{points:"23 6 13.5 15.5 8.5 10.5 1 18"}),e.jsx("polyline",{points:"17 6 23 6 23 12"})]}),$=()=>e.jsxs("svg",{width:"11",height:"11",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",children:[e.jsx("path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14"}),e.jsx("polyline",{points:"22 4 12 14.01 9 11.01"})]}),H=()=>e.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"#1daf66",strokeWidth:"2.2",children:e.jsx("path",{d:"M22 12h-4l-3 9L9 3l-3 9H2"})}),D=()=>e.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"#FFA726",strokeWidth:"2.2",children:[e.jsx("line",{x1:"12",y1:"1",x2:"12",y2:"23"}),e.jsx("path",{d:"M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"})]}),G=()=>e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"#1daf66",strokeWidth:"2.5",children:e.jsx("path",{d:"M13 2L3 14h9l-1 8 10-12h-9l1-8z"})}),J=()=>e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"#FFA726",strokeWidth:"2.5",children:e.jsx("path",{d:"M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"})}),V=()=>e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.2",children:[e.jsx("line",{x1:"12",y1:"1",x2:"12",y2:"23"}),e.jsx("path",{d:"M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"})]}),X=()=>e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.2",children:e.jsx("path",{d:"M22 12h-4l-3 9L9 3l-3 9H2"})}),_=`
