import{r as n,j as e,T as U,a as Z,C as Q,b as X}from"./index-I-kEU_k8.js";import{C as J,a as G}from"./CalculadoraTextBlock-Bi7-yHF5.js";const N=.07,K=.2,w="14,0",C="30",p=30,I={pouca:.25,media:.2,muita:.15},M={pouca:{label:"Pouco",limiarPct:.1,prefixo:"até"},media:{label:"Médio",limiarPct:.25,prefixo:"até"},muita:{label:"Muito",limiarPct:.25,prefixo:"mais de"}},v=a=>parseFloat(a.replace(/\./g,"").replace(",","."))||0,d=a=>a.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}),D=a=>{const o=a.replace(/\D/g,"");return o?(parseInt(o,10)/100).toLocaleString("pt-BR",{minimumFractionDigits:2}):""};function ee(a,o){const r=M[a],l=o*r.limiarPct;return`Variação de ${r.prefixo} R$ ${d(l)} entre meses`}function ae(a,o,r){return a<=0||o<=0?0:r===0?a/o:a*r/(1-Math.pow(1+r,-o))}function re(a,o,r){return a<=0||o<=0?0:r===0?a*o:a*(1-Math.pow(1+r,-o))/r}function O({text:a}){return e.jsxs(U,{children:[e.jsx(Z,{asChild:!0,children:e.jsx("button",{type:"button",className:"vt-tooltip-btn","aria-label":"Mais informações",children:e.jsx(Q,{size:14})})}),e.jsx(X,{className:"max-w-[240px] text-xs leading-snug",children:a})]})}function y({label:a,value:o,sub:r,subAsPill:l=!1,delay:h=0,visible:f}){return e.jsxs("div",{className:"result-card result-card--tone-green",style:{transitionDelay:`${h}ms`,opacity:f?1:0,transform:f?"translateY(0)":"translateY(12px)",transition:"opacity 0.45s ease, transform 0.45s ease"},children:[e.jsx("p",{className:"result-label",children:a}),e.jsx("p",{className:"result-value",children:o}),r&&(l?e.jsx("span",{className:"result-pill",children:r}):e.jsx("p",{className:"result-sub",children:r}))]})}function ie(){const[a,o]=n.useState(""),[r,l]=n.useState(null),[h,f]=n.useState(""),[g,W]=n.useState(C),[x,B]=n.useState(w),[i,_]=n.useState(null),[c,R]=n.useState(!1),k=n.useRef(null),b=v(a)>0,L=()=>{const t=v(a),s=v(h),m=Math.min(p,parseInt(g,10)||0),$=(parseFloat(x.replace(",","."))||0)/100;if(!t||!s||!r||!m)return;const A=m*12,T=Math.pow(1+$,1/12)-1,E=s/(K+N),Y=I[r],V=t*Y,z=(re(V,A,T)+s)/(1+N),H=E<=z?"entrada":"renda",u=Math.min(E,z),P=N*u,j=Math.max(0,s-P),F=Math.max(0,u-j),q=ae(F,A,T);_({precoRecomendado:u,entradaEfetiva:j,custosCartorarios:P,financiamento:F,parcelaEstimada:q,percentualRendaComprometida:t>0?q/t*100:0,percentualEntradaFinal:u>0?j/u*100:0,limitante:H}),R(!1),setTimeout(()=>R(!0),50),window.innerWidth<768&&setTimeout(()=>{var S;return(S=k.current)==null?void 0:S.scrollIntoView({behavior:"smooth",block:"start"})},150)};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .vt-root {
