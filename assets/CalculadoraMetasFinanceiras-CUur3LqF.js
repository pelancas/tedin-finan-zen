import{r,j as e,S,O as A}from"./index-CFpxaSTb.js";import{C as W}from"./CalculadoraSidebar-BNODOTF_.js";import{C as D}from"./CalculadoraTextBlock-P6LOvfj0.js";const k=t=>parseFloat(t.replace(/\./g,"").replace(",","."))||0,f=t=>t.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}),y=t=>{const s=t.replace(/\D/g,"");return s?(parseInt(s,10)/100).toLocaleString("pt-BR",{minimumFractionDigits:2}):""};function v({label:t,value:s,accent:n,delay:m=0,visible:l}){return e.jsxs("div",{className:"result-card",style:{borderLeft:`4px solid ${n}`,transitionDelay:`${m}ms`,opacity:l?1:0,transform:l?"translateY(0)":"translateY(12px)",transition:"opacity 0.45s ease, transform 0.45s ease"},children:[e.jsx("p",{className:"result-label",children:t}),e.jsxs("p",{className:"result-value",children:["R$ ",s]})]})}function P(){const[t,s]=r.useState(""),[n,m]=r.useState(""),[l,N]=r.useState(""),[x,C]=r.useState("Anos"),[g,z]=r.useState("14"),[o,q]=r.useState(null),[p,b]=r.useState(!1),u=r.useRef(null),F=()=>{const a=k(t),i=k(n),R=(parseFloat(g.replace(",","."))||0)/100,j=parseInt(l,10)||0,d=x==="Anos"?j*12:j;if(!a||!d)return;const h=Math.pow(1+R,1/12)-1;let c=0;if(h===0)c=Math.max(0,(a-i)/d);else{const w=Math.pow(1+h,d);c=Math.max(0,(a-i*w)/((w-1)/h))}const E=c*d+i,M=Math.max(0,a-E);q({monthlyPayment:c,totalSaved:a,interestEarned:M}),b(!1),setTimeout(()=>b(!0),50)};return r.useEffect(()=>{o&&u.current&&window.innerWidth<768&&setTimeout(()=>{var i;return(i=u.current)==null?void 0:i.scrollIntoView({behavior:"smooth",block:"start"})},100)},[o]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .vt-root {
      ...
      `}),e.jsxs("div",{className:"vt-root",children:[e.jsxs("section",{className:"vt-hero",children:[e.jsxs("div",{className:"vt-hero-inner",children:[e.jsxs("nav",{className:"vt-breadcrumb",children:[e.jsx("a",{href:"#",children:"Home"}),e.jsx("span",{children:"/"}),e.jsx("a",{href:"#",children:"Ferramentas"}),e.jsx("span",{children:"/"}),e.jsx("span",{style:{color:"#d9d4c4"},children:"Calculadora"})]}),e.jsxs("h1",{children:["Calculadora de"," ",e.jsx("span",{children:"Metas Financeiras"})]}),e.jsx("p",{children:"Quer comprar um carro? Uma Casa? Use a calculadora para ver quanto precisa economizar para chegar onde quer."}),e.jsx(S,{title:"Calculadora de Metas Financeiras | Orienta",style:{marginTop:"20px"}})]}),e.jsx("svg",{className:"vt-hero-blob",viewBox:"0 0 200 200",xmlns:"http://www.w3.org/2000/svg",children:e.jsx("path",{d:"M44.7,-76.4C58.3,-69.2,70.1,-57.4,77.6,-43.3C85.2,-29.2,88.5,-12.8,87.3,3.3C86.1,19.4,80.4,35.2,70.9,48.2C61.3,61.2,47.9,71.4,33.1,77.4C18.3,83.4,2.2,85.1,-13.7,81.9C-29.5,78.7,-45.1,70.5,-57.8,59.3C-70.5,48.1,-80.4,33.9,-84.6,18.5C-88.7,3,-87.1,-13.7,-80.3,-28.4C-73.6,-43.1,-61.7,-55.8,-48.2,-63C-34.7,-70.2,-19.5,-71.9,-2.4,-67.7C14.7,-63.5,29.3,-53.4,44.7,-76.4Z",fill:"#abccb5",transform:"translate(100 100)"})})]}),e.jsxs("main",{className:"vt-main",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"vt-section-heading",children:[e.jsxs("h2",{children:[e.jsxs("svg",{width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8.5 3.3 1.5 4.2C6 18 6 19 6 19h12s0-1-.5-2.8c1-.9 1.5-2.4 1.5-4.2 0-1-.25-1.75-.5-2.5L20 8s1-5-1-3z"}),e.jsx("path",{d:"M2 9v1c0 1.1.9 2 2 2h1"}),e.jsx("path",{d:"M16 11h0"})]}),"Quanto preciso poupar por mês?"]}),e.jsx("p",{children:"Diga-nos quanto você quer guardar e quando quer atingir sua meta."})]}),e.jsxs("div",{className:"vt-card",children:[e.jsxs("div",{className:"vt-form-two-col",children:[e.jsxs("div",{className:"vt-field vt-field-highlight vt-field-highlight--full",children:[e.jsxs("span",{className:"vt-field-badge",children:[e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("polyline",{points:"23 6 13.5 15.5 8.5 10.5 1 18"}),e.jsx("polyline",{points:"17 6 23 6 23 12"})]}),"Objetivo principal"]}),e.jsx("label",{className:"vt-label",children:"Meta de Economia (R$)"}),e.jsxs("div",{className:"vt-input-wrap",children:[e.jsx("span",{className:"vt-prefix",children:"R$"}),e.jsx("input",{className:"vt-input has-prefix",placeholder:"Ex: 50.000,00",value:t,onChange:a=>s(y(a.target.value))})]}),e.jsx("p",{className:"vt-field-hint",children:"Quanto você quer acumular no total?"})]}),e.jsxs("div",{className:"vt-fields-col",children:[e.jsxs("div",{className:"vt-field vt-field-sm",children:[e.jsx("label",{className:"vt-label",children:"Saldo Inicial (R$)"}),e.jsxs("div",{className:"vt-input-wrap",children:[e.jsx("span",{className:"vt-prefix",children:"R$"}),e.jsx("input",{className:"vt-input vt-input-sm has-prefix",placeholder:"Ex: 5.000,00",value:n,onChange:a=>m(y(a.target.value))})]})]}),e.jsxs("div",{className:"vt-field vt-field-sm",children:[e.jsx("label",{className:"vt-label",children:"Prazo para Crescer"}),e.jsxs("div",{className:"vt-period-row",children:[e.jsx("input",{className:"vt-input vt-input-sm",style:{flex:1},placeholder:"Valor",type:"number",min:1,value:l,onChange:a=>N(a.target.value)}),e.jsxs("select",{className:"vt-select vt-select-sm",value:x,onChange:a=>C(a.target.value),children:[e.jsx("option",{children:"Anos"}),e.jsx("option",{children:"Meses"})]})]})]}),e.jsxs("div",{className:"vt-field vt-field-sm",children:[e.jsx("label",{className:"vt-label",children:e.jsxs("span",{className:"vt-tooltip-wrap",children:["Taxa de Juros (% ao ano)",e.jsx("span",{className:"vt-tooltip-icon",children:"?"}),e.jsx("span",{className:"vt-tooltip-box",children:"Taxa de juros nominal, possível de obter hoje, isento de imposto — a sugestão é 14% ao ano."})]})}),e.jsxs("div",{className:"vt-input-wrap",children:[e.jsx("input",{className:"vt-input vt-input-sm has-suffix",placeholder:"Ex: 10,5",value:g,onChange:a=>z(a.target.value)}),e.jsx("span",{className:"vt-suffix",children:"%"})]})]})]})]}),e.jsxs("button",{className:"vt-btn",onClick:F,children:["Calcular Meta",e.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"}),e.jsx("polyline",{points:"12 5 19 12 12 19"})]})]})]}),e.jsxs("div",{className:"vt-results-grid",ref:u,children:[e.jsx(v,{label:"Total a Poupar",value:o?f(o.totalSaved):"0,00",accent:"#1a4537",delay:0,visible:p}),e.jsx(v,{label:"Parcela Mensal",value:o?f(o.monthlyPayment):"0,00",accent:"#618c70",delay:80,visible:p}),e.jsx(v,{label:"Juros Ganhos",value:o?f(o.interestEarned):"0,00",accent:"#abccb5",delay:160,visible:p})]})]}),e.jsx(W,{promo:{image:"https://lh3.googleusercontent.com/aida-public/AB6AXuBiIAZZ1_Gx_i7qJnBZuqdTW1gDH3BRnNYO_BEfyALedW6hdQWTMrCxvimHAEd8ExDNnqlKeuvR-2F8QjxPY9Dqa6TRS04rbJ4IHfWuEKjtYGv7TfDybTd72owjQcX4oPr4yCEaVGqfCSdYjZuiJMMUjzND-N92XHg60Wl0AW6pVWYbkVseir6LsmR7lMTIUZUghLYar5-r4fWxk-6_SdT0ZodH-4-NK0c10UUt2AWOvWW4ONhyInd5nJ0-mswYeBWEQUOaxjfpSaAH",imageAlt:"Moedas empilhadas com planta crescendo",badge:"Destaque",title:"Quanto de seguro de vida você precisa?",description:"Descubra o capital ideal para proteger quem depende de você.",href:"#/seguros"},resources:[{icon:"article",title:"As Melhores Formas de Economizar",desc:"Pequenas mudanças, grandes resultados.",href:"#/planejamento/despesas"},{icon:"stats",title:"Comparador de Renda Fixa",desc:"Calcule qual melhor produto.",href:"#/investimentos/renda-fixa/comparador"},{icon:"bank",title:"Fundos, o que são",desc:"Qual o melhor para sua meta?",href:"#/investimentos/fundos"},{icon:"calc",title:"Calculadora de Aposentadoria",desc:"O poder do tempo ao seu favor.",href:"#/planejamento/calculadoras/aposentadoria"}]})]}),e.jsxs(D,{children:[e.jsx("h2",{className:"text-3xl font-bold text-foreground mb-6",children:"Por que poupar dinheiro?"}),e.jsx("p",{children:"Apesar de você já ter muitas metas claras do que você quer, seja um carro, uma casa ou a sua aposentadoria, é necessário que você se planeje para identificar o que precisa para chegar onde quer. E uma das melhores formas de fazer isso é planejando uma poupança mensal, planejando os seus gastos de forma com que eles se alinhem com o seu futuro."}),e.jsx("h3",{className:"text-2xl font-bold text-foreground mt-10 mb-4",children:"Como funciona a cálculadora"}),e.jsx("p",{children:"O que você vai preencher nessa calculadora é a sua meta, em quanto você quer chegar, o quanto você tem de dinheiro hoje no saldo inicial, o prazo que tem pra chegar nessa meta e a taxa de juros atual de algum investimento. Geralmente, você pode colocar a taxa SELIC ou o CDI."}),e.jsx("h3",{className:"text-2xl font-bold text-foreground mt-10 mb-4",children:"Exemplo simples"}),e.jsx("p",{children:"Imagine que você:"}),e.jsxs("ul",{children:[e.jsx("li",{children:"Guarde R$ 1.000 inicialmente"}),e.jsx("li",{children:"Deposite R$ 200 por mês"}),e.jsx("li",{children:"Tenha um rendimento médio de 0,6% ao mês"})]}),e.jsx("p",{children:"No primeiro mês, os juros incidem sobre o saldo inicial. Nos meses seguintes, os juros incidem sobre todo o valor acumulado, incluindo os rendimentos anteriores."}),e.jsx("h3",{className:"text-2xl font-bold text-foreground mt-10 mb-4",children:"Dicas para poupar de forma eficaz"}),e.jsxs("ul",{children:[e.jsx("li",{children:"Definir um percentual da renda para guardar todos os meses"}),e.jsx("li",{children:"Automatizar transferências para uma conta ou investimento"}),e.jsx("li",{children:"Estabelecer objetivos claros, como uma reserva de emergência ou um projeto específico"}),e.jsx("li",{children:"Evitar utilizar os recursos poupados para despesas não planejadas"})]}),e.jsx("p",{children:"Poupar regularmente, mesmo que em valores modestos, pode gerar um impacto significativo no longo prazo."}),e.jsx("div",{className:"bg-primary/10 border border-primary/30 rounded-lg p-6 mt-8",children:e.jsx("p",{className:"text-foreground font-semibold mb-0",children:"✅ Em resumo: poupar é uma forma de construir estabilidade financeira e aproveitar o poder dos juros compostos. Quanto mais consistente for o hábito e maior o tempo de investimento, maior tende a ser o crescimento do patrimônio."})})]}),e.jsx(A,{})]})]})}export{P as default};
